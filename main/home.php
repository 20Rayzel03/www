...
<body>
    ...
    <div class="container">
      ...
      <div class="row section-row justify-content-center">
        <div class="col-md-4 mb-3">
          <img src="assets/images/real_me.png" alt="Profilbild" class="section-image img-fluid">
        </div>
    ...
    <div class="container">
      ...
      <div class="row section-row justify-content-center">
        <div class="col-md-4 mb-3 order-md-2">
          <img src="assets/images/real_me.png" alt="Projekte Übersicht" class="section-image img-fluid">
        </div>
  ...
  <section id="contact" class="py-5 text-center">
    <div class="container">
      ...
      <div class="row section-row justify-content-center">
        <div class="col-md-4 mb-3">
          <img src="assets/images/real_me.png" alt="Kontakt Illustration" class="section-image img-fluid">
